...
export function MobileSiteShell({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-full bg-[#EDE8E1]">
      <div className="mx-auto flex min-h-full w-full max-w-[430px] flex-col bg-[var(--background)] shadow-[0_0_0_1px_rgba(26,18,16,0.06),0_24px_80px_rgba(26,18,16,0.12)]">
        {children}
      </div>
    </div>
  );
